...
public class Pruebacontrol  implements java.io.Serializable {
    ...
    public Pruebacontrol(int termometro) {
        this.termometro = termometro;
    }
    public Pruebacontrol(int termometro, Integer presion, Integer saquemarcha, String sobrevelocidad, String ubt, Boolean operacionubt, Boolean cargaliena, Boolean altatemperatura, Boolean bajapresion, Boolean fallageneral, Boolean arranquemanual, Boolean bajepresion, Boolean temperatura, Boolean proteccionsobrevelocidad, Integer intentosarranque, Integer duraciontotal, String pruebacontrolcol) {
       this.termometro = termometro;
